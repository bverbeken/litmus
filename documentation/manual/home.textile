...
* next to that, you get a number of custom Play-specific Assert classes, so you can write asserts on
** cookies
** flash variables
** header parameters
** the html in the response body
** the render arguments you passed to the view in your controller
** the response itself (contentType, http status code, ...)
